...
impl MMU {
  ...
  pub fn read(&self, address: u16) -> u8 {
    let result = match address {
      ...
      0xE000..=0xFDFF => self.work_ram[address as usize - 0xC000 - 0x2000], // ECHO work ram
      0xFE00..=0xFE9F => self.sprite_info[address as usize - 0xFE00],
      0xFF00 => self.input.read(),
      0xFF04..=0xFF07 => self.timer.read(address),
      0xFF01..=0xFF0E => self.io[address as usize - 0xFF00],
      0xFF0F => self.interrupt_flags,
      0xFF10..=0xFF3F => self.io[address as usize - 0xFF00],
      addr @ 0xFF40..=0xFF7F => match addr {
        0xFF40..=0xFF7F => {
      ...
      0xFF80..=0xFFFE => self.zram[address as usize - 0xFF80],
  ...
  pub fn write(&mut self, address: u16, data: u8) {
    match address {
      ...
      0xFEA0..=0xFEFF => {} // no-op
      0xFF00 => self.input.write(data),
      0xFF04..=0xFF07 => self.timer.write(address, data),
      0xFF01..=0xFF0E => self.io[address as usize - 0xFF00] = data,
      0xFF0F => {
        self.interrupt_flags = data;
      }
      0xFF10..=0xFF3F => self.io[address as usize - 0xFF00] = data,
      ...
      0xFF80..=0xFFFE => self.zram[address as usize - 0xFF80] = data,
      0xFFFF => {
